...
function renderPage(page) {
  ...
  const adminOnlyPages = ['maintenance','add-membership','update-membership','add-book','update-book','user-mgmt'];
  if (adminOnlyPages.includes(page) && !DB.isAdmin()) {
    navigate(DB.isAdmin() ? 'admin-home' : 'user-home');
